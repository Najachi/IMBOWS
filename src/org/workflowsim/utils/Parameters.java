...
public class Parameters {
    ...
    public enum SchedulingAlgorithm {
        ...
        MAXMIN, MINMIN, MCT, DATA, PSO, IMBO,
        STATIC, FCFS, ROUNDROBIN, INVALID, GA
    }
    
    public enum Optimization{//优化目标
    	Time, Energy, Cost, reliability, availability, latency
    }
     ...
     * Note information
     */
    private static final String note = " supports planning algorithm at January, 2024";
    /**
     * Overhead parameters
     */
